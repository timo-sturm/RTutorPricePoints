...
library(RTutor)
check.problem.set('PricePoints', ps.dir, ps.file, user.name=user.name, reset=FALSE)
...
info("R-Functions: readRDS() and head()") # Run this line (Strg-Enter) to show info
...
info("Variables of Interest for this Chapter") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Number of Observations.
...
info("Pipe operator (%>%), arrange() and select()") # Run this line (Strg-Enter) to show info
...
info("Column Referencing with $ and [[]]") # Run this line (Strg-Enter) to show info
...
info("Functions within summarise()") # Run this line (Strg-Enter) to show info
...
info("R-Functions: group_by() and summarise()") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Table Interpretation.
...
info("Price Ending Colums") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Understanding Columns.
...
#! addon__quiz__Least frequent Ending.
...
info("R-Functions: cbind() and setNames()") # Run this line (Strg-Enter) to show info
...
info("R-package: ggplot2 - Components of Interest") # Run this line (Strg-Enter) to show info
...
info("R-Function: seq()") # Run this line (Strg-Enter) to show info
...
**Task**: Run the code below.
```{r "2_0__8",fig.width=15, fig.height=5}
...
info("R-Function: grid.arrange()") # Run this line (Strg-Enter) to show info

**Task**: Run the code.
```{r "2_0__11",fig.width=12, fig.height=10}
...
```{r "2_0__12",fig.width=15, figh.height=5}
...
**Task**: Run the code.
```{r "2_0__13",fig.width=12, figh.height=16}
...
info("R-Function: n()") # Run this line (Strg-Enter) to show info
...
info("R-Function: mutate()") # Run this line (Strg-Enter) to show info
...
#! addon__quiz__Comparison of Transitions
...
**Task**: Run the code.
```{r "3_1__6",fig.width=15, fig.height=5}
...
info("Code Description: Heat Map with ggplot2") # Run this line (Strg-Enter) to show info

Now, let us create the heat maps for the transition probabilities.

**Task**: Run the code.
```{r "3_1__7",fig.width=8, fig.height=12}
...
#! addon__quiz__Comparison of the Internet Transitions
...
info("Value Matching with %in%") # Run this line (Strg-Enter) to show info
...
info("R-Functions: set.seed() and rbinom()") # Run this line (Strg-Enter) to show info
...
info("ML with Newton-Rhapson: Variable Description") # Run this line (Strg-Enter) to show info
...
info("R-Function: glm()") # Run this line (Strg-Enter) to show info
...
info("R-Function: stargazer()") # Run this line (Strg-Enter) to show info
...
info("R-Functions: tidy() and do()") # Run this line (Strg-Enter) to show info
...
info("Logit Regression for Dominick's: R-Code") # Run this line (Strg-Enter) to show info

Before we continue by observing the output table, guess the regression results. 

**Quiz 9: Coefficient Relation**

#! addon__quiz__Coefficient Relation
...
info("R-Functions: muatate_at() and signif()") # Run this line (Strg-Enter) to show info
...
info("R-Function: bife()") # Run this line (Strg-Enter) to show info
...
info("Code for Summary Table with fixed Effects") # Run this line (Strg-Enter) to show info
...
**Task**: Run the code!
```{r "4_2__8",fig.width=15, fig.height=5}
...
info("Code for Summary Table with fixed Effects for the Internet Data") # Run this line (Strg-Enter) to show info
...
info("R-Package: condformat()") # Run this line (Strg-Enter) to show info


**Task**: Run the code that performs conditional formatting!
```{r "4_2__10",fig.width=12, fig.height=6}
...
```{r "5_0__5",fig.width=15, fig.height=5}
...
info("Students t-Test in R") # Run this line (Strg-Enter) to show info
...
info("R-Function: pt()") # Run this line (Strg-Enter) to show info
...
**Task**: Run the code.
```{r "5_0__12",fig.width=8, fig.height=8}
...
#! addon__quiz__Levy's Assumptions
...
**Task**: Run the code.
```{r "6_0__2",fig.width=14, fig.height=8}
...
#! addon__quiz__Robustness - Histogram Comparison
...
info("Look up Your Rank!") # Run this line (Strg-Enter) to show info
